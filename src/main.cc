...
void app_main(void)
{
    LED::RGB_LED rgb_led(RGB_LED_RED_GPIO, RGB_LED_GREEN_GPIO, RGB_LED_BLUE_GPIO); //= new LED::RGB_LED(RGB_LED_RED_GPIO, RGB_LED_GREEN_GPIO, RGB_LED_BLUE_GPIO);
    ...
    while (true)
    {
        printf("inicio\n");
        printf("CPPr\n");
        rgb_led.rgb_led_set_color(1, 0, 0);
        vTaskDelay(1000 / portTICK_PERIOD_MS);
        printf("CPPg\n");
        rgb_led.rgb_led_set_color(0, 1, 0);
        vTaskDelay(1000 / portTICK_PERIOD_MS);
        printf("CPPb\n");
        rgb_led.rgb_led_set_color(0, 0, 1);
        vTaskDelay(1000 / portTICK_PERIOD_MS);
        printf("fim\n");
